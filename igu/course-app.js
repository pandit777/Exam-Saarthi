...
const navItems = [
  ...
  { name: 'Universities', href: '/Universities.html', active: false },
  { name: 'About', href: '/About.html', active: false },
  { name: 'Contact', href: '/Contact.html', active: false },
  { name: 'Syllabus', href: 'https://igu.ac.in/iguacademic?show=3', active: false, target: '_blank' }
];
...
marqueeContent.innerHTML = '<i class="fas fa-bullhorn mr-2"></i> Welcome to the IGU PYQ Portal - Your Gateway to Academic Excellence! Explore courses and previous year papers.';
...
mainTitle.textContent = 'Explore IGU Courses';
