...
const navItems = [
  ...
  { name: 'Syllabus', href: 'https://www.du.ac.in/index.php?page=revised-syllabi-ug', active: false, target: '_blank' }
];
...
marqueeContent.innerHTML = '<i class="fas fa-bullhorn mr-2"></i> Welcome to the DU PYQ Portal - Your Gateway to Academic Excellence! Explore courses and previous year papers.';
...
mainTitle.textContent = 'Explore DU Courses';
