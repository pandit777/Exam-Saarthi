...
const navItems = [
  ...
  { name: 'Syllabus', href: 'https://www.ccsuniversity.ac.in/syllabus/', active: false, target: '_blank' }
];
...
marqueeContent.innerHTML = '<i class="fas fa-bullhorn mr-2"></i> Welcome to the CCSU PYQ Portal - Your Gateway to Academic Excellence! Explore courses and previous year papers.';
...
mainTitle.textContent = 'Explore CCSU Courses';
