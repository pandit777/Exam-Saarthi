...
const navItems = [
  ...
  { name: 'Syllabus', href: 'https://www.jnu.ac.in/scss-syllabus', active: false, target: '_blank' }
];
...
marqueeContent.innerHTML = '<i class="fas fa-bullhorn mr-2"></i> Welcome to the JNU PYQ Portal - Your Gateway to Academic Excellence! Explore courses and previous year papers.';
...
mainTitle.textContent = 'Explore JNU Courses';
