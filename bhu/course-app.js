...
const navItems = [
  ...
  { name: 'Syllabus', href: 'https://www.bhu.ac.in/Site/Programme/1_2_17_386_Main-Site-Programmes', active: false, target: '_blank' }
];
...
marqueeContent.innerHTML = '<i class="fas fa-bullhorn mr-2"></i> Welcome to the BHU PYQ Portal - Your Gateway to Academic Excellence! Explore courses and previous year papers.';
...
mainTitle.textContent = 'Explore BHU Courses';
