...
const navItems = [
  ...
  { name: 'Syllabus', href: 'https://bpsmv.ac.in/ASPX/LandingPage?PageId=263', active: false, target: '_blank' }
];
...
marqueeContent.innerHTML = '<i class="fas fa-bullhorn mr-2"></i> Welcome to the BPS PYQ Portal - Your Gateway to Academic Excellence! Explore courses and previous year papers.';
...
mainTitle.textContent = 'Explore BPS Courses';
