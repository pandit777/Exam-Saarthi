...
const navItems = [
  ...
  { name: 'Syllabus', href: 'https://gjust.ac.in/Page/Index_2_cat/Scheme-Syllabus/3221', active: false, target: '_blank' }
];
...
marqueeContent.innerHTML = '<i class="fas fa-bullhorn mr-2"></i> Welcome to the GJU PYQ Portal - Your Gateway to Academic Excellence! Explore courses and previous year papers.';
...
mainTitle.textContent = 'Explore GJU Courses';
