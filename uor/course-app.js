...
const navItems = [
  ...
  { name: 'Syllabus', href: 'https://www.uniraj.ac.in/index.php?mid=3102', active: false, target: '_blank' }
];
...
marqueeContent.innerHTML = '<i class="fas fa-bullhorn mr-2"></i> Welcome to the UOR PYQ Portal - Your Gateway to Academic Excellence! Explore courses and previous year papers.';
...
mainTitle.textContent = 'Explore UOR Courses';
